                ...
                post.status === 200 ?
                    (<section className="text-gray-600 body-font">
                        <div className="flex flex-col px-5 py-24 justify-start items-center">
                            <img className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src={post.data.jetpack_featured_media_url} />
                            <div className="w-full md:w-2/3 flex flex-col mb-16 ml-4">
                                <h1 className='text-4xl mb-5 ' dangerouslySetInnerHTML={{ __html: post.data.title.rendered }} />
